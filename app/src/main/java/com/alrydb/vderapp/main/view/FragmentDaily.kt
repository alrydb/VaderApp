...
class FragmentDaily : Fragment() {
    ...
    fun showWeatherDetails(dateTime: String, maxTemp: Double, minTemp: Double, description: String, rain : Double, wind : Double, clouds : Double, humidity : Double, icon : String, sunrise : String, sunset :String)
    {
